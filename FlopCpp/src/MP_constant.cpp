...
namespace flopc {
    ...
    {
        std::stringstream ss;
        ss<<"min("<<left.toString()<<','<<right.toString()<<')';
        return ss.str();
    }
    private:
    ...
    {
        std::stringstream ss;
        ss<<"max("<<left.toString()<<','<<right.toString()<<')';
        return ss.str();
    }
    ...
    {
        std::stringstream ss;
        ss<<"(max of "<<exp.toString()<<" over ("<<d.toString()<<')'<<')';
        return ss.str();
    }
    private:
    ...
    {
        std::stringstream ss;
        ss<<"(min of "<<exp.toString()<<" over ("<<d.toString()<<')'<<')';
        return ss.str();
    }
    private:
    ...
    {
        std::stringstream ss;
        ss<<"(sum of "<<exp.toString()<<" over ("<<d.toString()<<')'<<')';
        return ss.str();
    }
    private:
    ...
    {
        std::stringstream ss;
        ss<<"(product of "<<exp.toString()<<" over ("<<d.toString()<<')'<<')';
        return ss.str();
    }
    private:
