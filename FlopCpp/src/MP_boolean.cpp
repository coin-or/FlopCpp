...
namespace flopc {
   ...
   private:
    ...
    public:
        ...
        {
            std::stringstream ss;
            ss<<"Bool:and("<<left->toString()<<" && "<<right->toString()<<")";
            return ss.str();
        }
    ...
    public:
        ...
        {
            std::stringstream ss;
            ss<<"Bool:or("<<left->toString()<<" || "<<right->toString()<<")";
            return ss.str();
        }
    private:
    ...
    public:
        ...
        {
            std::stringstream ss;
            ss<<"Bool:alltrue("<<D.toString()<<" && "<<B.toString()<<")";
            return ss.str();
        }
    private:
    ...
    public:
        ...
        {
            std::stringstream ss;
            ss<<"Comp:<=("<<left.toString()<<" && "<<right.toString()<<")";
            return ss.str();
        }
    private:
...
std::string MP_boolean::toString()const
    {
